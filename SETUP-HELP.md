# Admin Items - Setup help

Everything you need to get **Admin Items** running, step by step. If something goes wrong, check *Troubleshooting* at the end.
...
1. Download **`Admin-Items-v1.0.1.mcaddon`** from the [Releases page](../../releases) - or directly from this repository.
...
- The **first player who joins a world becomes the owner** automatically.
- Right-click the **Admin Menu** to grant or revoke each wand per player and to tune radius, counts and spread.
- Authorised players keep their wands (they come back after death or a drop); everybody else loses them immediately.
